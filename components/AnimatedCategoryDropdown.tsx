...
// const AnimatedCategoryDropdown: React.FC = () => {
...
//     { id: 1, name: "تحليل القطاعات", icon: BarChart },
//     { id: 2, name: "البحوث المالية", icon: FileSearch },
//     { id: 3, name: "التحليل المالي", icon: LineChart },
//     { id: 4, name: "قصة سهم", icon: TrendingUp },
//     { id: 5, name: "المصطلحات المالية", icon: BookOpen },
//     { id: 6, name: "مختارات إثمار المالية", icon: Star },
//   ];
